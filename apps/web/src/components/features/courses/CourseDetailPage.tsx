...
import { useCourseReviews, useCreateCourseReview } from "@/hooks/queries/use-reviews";
...
function ReviewsSection({ courseSlug, t }: { courseSlug: string; t: (k: string) => string }) {
              ...
              <div className="flex items-start gap-x-3">
                ...
                <div className="flex flex-col gap-y-1 min-w-0">
                  ...
                  <div className="flex items-center gap-x-2">
                    ...
                    {!r.isApproved && me && r.userId === me.id && (
      ...
      {open && (
        <div className="flex flex-col gap-y-2.5 sm:ps-4 mt-3">
          {section.lessons.map((lesson, idx) => {
            const rowCls = "flex items-center justify-between gap-x-4 md:gap-x-6 border border-gray-100 hover:border-[var(--brand)]/40 pe-3.5 ps-1.5 py-3 rounded-lg group transition-colors";
            const rowContent = (
              <>
                <div className="flex items-center gap-x-2.5">
      ...
      <div className="container">
        <div className="flex flex-col lg:flex-row gap-7">
          ...
          <div className="flex flex-col gap-y-6 md:gap-y-8 lg:grow min-w-0">
            ...
            <ReviewsSection courseSlug={courseSlug} t={t} />
