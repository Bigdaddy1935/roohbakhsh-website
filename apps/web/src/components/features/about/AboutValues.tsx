      ...
      <div className="container">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
          {VALUES.map(({ key, Icon, color }) => (
            <div key={key} className="flex flex-col items-center text-center gap-y-4 p-7 rounded-md bg-white border border-gray-100 transition-colors duration-300">
              <div className={`size-14 rounded-md bg-gradient-to-br ${color} flex items-center justify-center`}>
