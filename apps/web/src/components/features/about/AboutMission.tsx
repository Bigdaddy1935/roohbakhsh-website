    ...
    <section className="py-16 bg-white">
      <div className="container">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          {/* Mission */}
          <div className="p-8 rounded-3xl border border-[var(--brand)]/15 bg-gradient-to-br from-[#edfaf5] to-white">
            <div className="size-12 rounded-2xl bg-[var(--brand)]/10 flex items-center justify-center mb-5">
          ...
          {/* Vision */}
          <div className="p-8 rounded-3xl border border-[var(--cta)]/15 bg-gradient-to-br from-[#fff8ee] to-white">
            <div className="size-12 rounded-2xl bg-[var(--cta)]/10 flex items-center justify-center mb-5">
