...
// ── token helpers ────────────────────────────────────────────────
// کوکی غیرحساس فقط برای تشخیص وضعیت ورود توسط middleware (سمت سرور به localStorage دسترسی ندارد).
// توکن واقعی هرگز اینجا ذخیره نمی‌شود — احراز هویت واقعی همچنان با Bearer token از localStorage است.
const AUTH_FLAG_COOKIE = "rh_auth";
