...
export const ERROR_MESSAGES: Record<string, LocalizedMsg> = {
  ...
  COUPON_NOT_FOUND: {
    ...
    ur: "ڈسکاؤنٹ کوڈ موجود نہیں یا غیر فعال ہے",
  },
  COUPON_CODE_TAKEN: {
    ar: "رمز الخصم هذا مستخدم مسبقاً",
    ur: "یہ ڈسکاؤنٹ کوڈ پہلے سے موجود ہے",
  },
  COUPON_EXPIRED_OR_EXHAUSTED: {
    ar: "رمز الخصم منتهي الصلاحية أو تم استنفاد الاستخدامات المسموحة",
    ur: "ڈسکاؤنٹ کوڈ کی میعاد ختم ہو گئی ہے یا استعمال کی حد پوری ہو گئی ہے",
  },
  COUPON_CURRENCY_REQUIRED: {
    ar: "يجب تحديد العملة للخصم الثابت",
    ur: "فکسڈ ڈسکاؤنٹ کے لیے کرنسی لازمی ہے",
  },
  COUPON_PERCENTAGE_MAX_100: {
    ar: "لا يمكن أن تتجاوز نسبة الخصم 100%",
    ur: "ڈسکاؤنٹ فیصد 100 سے زیادہ نہیں ہو سکتا",
  },
  // cart
  COURSE_ALREADY_IN_CART: {
    ar: "الدورة موجودة بالفعل في سلة التسوق",
    ur: "یہ کورس پہلے سے کارٹ میں موجود ہے",
  },
  CART_ITEM_NOT_FOUND: {
    ar: "العنصر غير موجود في سلة التسوق",
    ur: "یہ آئٹم کارٹ میں موجود نہیں",
  },
  // order
  CART_EMPTY: {
    ar: "سلة التسوق فارغة، لا يمكن إنشاء طلب",
    ur: "کارٹ خالی ہے، آرڈر نہیں بنایا جا سکتا",
  },
  MIXED_CURRENCIES: {
    ar: "لا يمكن دمج دورات بعملات مختلفة في طلب واحد",
    ur: "مختلف کرنسیوں کے کورسز ایک آرڈر میں شامل نہیں ہو سکتے",
  },
  ORDER_NOT_FOUND: {
    ar: "الطلب المطلوب غير موجود",
    ur: "مطلوبہ آرڈر موجود نہیں",
  },
  // payment
  ORDER_ALREADY_PAID: {
    ar: "تم دفع هذا الطلب مسبقاً",
    ur: "اس آرڈر کی ادائیگی پہلے ہی ہو چکی ہے",
  },
  ORDER_NOT_PAYABLE: {
    ar: "لا يمكن الدفع لهذا الطلب بسبب حالته الحالية",
    ur: "اس آرڈر کی موجودہ حالت کی وجہ سے ادائیگی ممکن نہیں",
  },
  PAYMENT_NOT_FOUND: {
    ar: "سجل الدفع غير موجود",
    ur: "ادائیگی کا ریکارڈ موجود نہیں",
  },
  PAYMENT_GATEWAY_ERROR: {
    ar: "خطأ في بوابة الدفع، يرجى المحاولة لاحقاً",
    ur: "پیمنٹ گیٹ وے میں خرابی، بعد میں دوبارہ کوشش کریں",
  },
  PAYMENT_CANCELLED: {
